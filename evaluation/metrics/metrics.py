...
def summarize(results: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    detected_errors = sum(not bool(r.get("first_verification_success")) for r in verified_rows)
    ...
    tokens = sum(_runtime_tokens(r.get("runtime")) for r in results)
    latency_ms = sum(
